...
\begin{proof}
	...
	\begin{itemize}
		...
		\item
            $V \setminus B_2 \ne \emptyset$ is a quorum in $\ev{V, Q}$ because because $\ev{V, Q}$ must enjoy quorum availability despite $B_2$ and $B_2 \ne V$.
            ...
            $(V \setminus B_1) \setminus B_2$ is a quorum in $\ev{V, Q}^{B_2}$ 
	...
	\end{itemize}
	Because $B_2$ is a DSet in $\ev{V, Q}$, $\ev{V, Q}^{B_2}$ enjoys quorum intersection.
	Therefore, $(U_a \setminus B_2) \cap ((V \setminus B_1) \setminus B_2) \ne \emptyset$.
	\begin{align*}
        \emptyset

...
\begin{defn}\label{def_accept}
    ...
    \begin{itemize}
        ...
        \item
            ...
            \begin{itemize}
                \item
                    There exists a quorum such that $v \in U$ and each member of $U$ either voted for $a$ or claims to accept $a$, or
                \item
                    There exists a $v$-blocking set $B$ such that every member of $B$ claims to accept $a$.
            \end{itemize}
    \end{itemize}
\end{defn}

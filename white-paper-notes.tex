...
Note that we haven't defined the definition of acceptance.
We will define in the next section, and every theorem in this section does not depend on the definition of acceptance.

...
\begin{proof}
    ...
    Since the set of all intact nodes is a quorum, that will let all the intact nodes accept and confirm \textit{nominate $x$} after sufficient messages have been delivered.

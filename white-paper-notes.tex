...
\begin{defn}\label{def_accept}
    ...
    \begin{itemize}
        ...
        \item
            ...
            \begin{itemize}
                \item
                    There exists a quorum such that $v \in U$ and each member of $U$ either voted for $a$ or broadcasted that it has accepted $a$, or
                \item
...
\begin{lmm}\label{lemma_for_every_intact_node}
    Let $\ev{V, Q}$ be an FBAS with quorum intersection.

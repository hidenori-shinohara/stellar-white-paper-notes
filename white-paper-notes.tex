...
\begin{proof}
    ...
    By Theorem~\ref{union_quorums}, $(V \setminus B_1) \cup (V \setminus B_2) = V \setminus B$ is a quorum in $\ev{V, Q}$.

    Next, we will show that $\ev{V, Q}$ enjoys quorum intersection despite $B$.
	Let $U_a, U_b$ be quorums in $\ev{V, Q}^B$.
    \begin{itemize}
        \item
            If we can show that $U_a \cap U_b \ne \emptyset$, we are done.
            We will do so by showing a stronger statement, which is $(U_a \cap U_b) \setminus B_1 \ne \emptyset$.
    ...
    In other words, at least one of $U_a \setminus B_1$ or $U_a \setminus B_2$ is non-empty.
    We will show that both $U_a \setminus B_1$ and $U_a \setminus B_2$ are non-empty.
    \todo[inline,caption={}]{
	...
	\begin{itemize}
		...
		\item
            We claim that $U_a \setminus B_1$ is a quorum in ${\ev{V, Q}}^{B_1}$.
            First, we know that $U_a$ is a quorum in $\ev{V, Q}^B$.
            Next, $(U_a \setminus B_1) \setminus B$ is nonempty because $(U_a \setminus B_1) \setminus B = U_a \setminus B_1 \ne \emptyset$.
            Then $(U_a \setminus B_1) \setminus B$ is a quorum in $(\ev{V, Q}^B)^{B_1}$ by Theorem~\ref{quorum_delete_fbas}.
            Since $(\ev{V, Q}^B)^{B_1} = \ev{V, Q}^{B_1}$, $U_a \setminus B_1$ is a quorum in $\ev{V, Q}^{B_1}$.
	\end{itemize}

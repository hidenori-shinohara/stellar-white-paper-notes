...
\begin{defn}[Weight, Neighbors, and Priority]
    ...
    \begin{align*}
        \weight(v, v') &= \frac{\abs{\{ q \mid q \in Q(v) \land v' \in q \}}}{\abs{Q(v)}} \\
...
\begin{exmp}
    ...
    \begin{align*}
        Q(v_5) &= \{ \{ v_5, v_1, v_2 \}, \{ v_5, v_1, v_3 \}, \{ v_5, v_1, v_4 \}, \cdots, \{ v_5, v_3, v_4 \} \},
    \end{align*}
    ...
    \begin{align*}
        \weight(v_5, v_1)
            &= \frac{\abs{ q \mid q \in Q(v_5) \land v_1 \in q }}{\abs{Q(v_5)}} \\
            &= \frac{\abs{ \{ v_5, v_1, v_2 \}, \{ v_5, v_1, v_3 \}, \{ v_5, v_1, v_4 \}}}{6} \\
            &= \frac{3}{6} = \frac{1}{2}.
    \end{align*}
    ...
    \begin{center}
      \begin{tabular}{ | c | c | }
        \hline
          $\weight(v_5, v_1), \weight(v_5, v_2), \weight(v_5, v_3), \weight(v_5, v_4)$
                      & $1 / 2$ \\ \hline 
          $\weight(v_5, v_5)$ & 1 \\ \hline 
          $\weight(v_5, v_6), \weight(v_5, v_7), \weight(v_5, v_8), \weight(v_5, v_9), \weight(v_5, v_{10})$
                      & 0 \\
        \hline
      \end{tabular}
    \end{center}

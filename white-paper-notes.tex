...
\begin{proof}
	...
	\begin{itemize}
		...
		\item
            $U_a \setminus B_1$ is a quorum in ${\ev{V, Q}}^{B_1}$ by Theorem~\ref{quorum_delete_fbas} because $U_a$ is a quorum in $\ev{V, Q}^B$ and $(U_a \setminus B_1) \setminus B = U_a \setminus B_1 \ne \emptyset$.
            \todo[inline,caption={}]{
                this seems wrong
            }
	\end{itemize}

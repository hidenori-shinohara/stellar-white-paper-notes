...
\begin{thm}
    ...
    Then $f$ is the maximum number of Byzantine failtures that the system can survive while
    \begin{itemize}
        \item
            maintaining safety (i.e., no two well-behaved nodes will agree on contradictory statements)
        \item
            maintaining liveliness (i.e., all well-behaved nodes can agree on any valid statements)
    \end{itemize}
\end{thm}
...
\begin{proof}
    ...
    This shows the liveliness of the system.
    ...
    We have shown that the system can survive while maintaining safety and liveliness with $b$ Byzantine failures.
    ...
    We cannot guarantee liveliness because Byzantine nodes can all disagree with everything. 
\end{proof}

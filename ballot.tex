...
\begin{thm}
    If $\varphi = \text{PREPARE}$, then $c.n \leq h.n \leq b.n$.
\end{thm}

\begin{proof}
    $ $
    \todo[inline,caption={}]{
        This is going to help me prove the invariant in Figure 16 in the white paper.
        And this doesn't seem terribly hard.
        next action?
    }
\end{proof}

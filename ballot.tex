...
\begin{thm}
    If $\varphi = \text{PREPARE}$ and $h = \textbf{0}$, then $v$ has not confirmed any ballot as prepared.
\end{thm}

\begin{proof}
    It suffices to show that if $\varphi = \text{PREPARE}$ and $v$ has confirmed a ballot as prepared, then $h \ne \textbf{0}$.

...
\begin{itemize}
    \item
        When a node confirms a new value through the nomination protocol,
    \item
        When a node receives a new message from another node.
\end{itemize}

\todo[inline,caption={}]{
    Explain how a node should update its state upon confirming a new value.
}

\todo[inline,caption={}]{
    Explain how a node should update its state upon receiving a new message.
}
